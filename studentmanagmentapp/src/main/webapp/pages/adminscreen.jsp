...
<body>
	<div class="card">
		...
		<section class="vh-100 gradient-custom enroll mt-2"
			style="height: 630px" id="enroll">
									...
									<div class="row">
										...
										<div class="col">
											...
											<select class="select form-control-sm" name="batchNumber">
												...
												<option value="FDJ-151">FDJ-151</option>
												<option value="REG-151">FDJ-151</option>
												<option value="REG-142">REG-142</option>
												<option value="FDJ-142">REG-142</option>
			...
			<div class="text-center w-100">
				<form action="search" class="w-100">
					<select class="select form-control-sm border border-primary"
						...
						<option value="REG-195">REG-195</option>
						<option value="FDJ-151">FDJ-151</option>
						<option value="REG-151">REG-152</option>
						<option value="FDJ-142">FDJ-142</option>
						<option value="REG-142">REG-142</option>
					</select>
							...
							<tr>
								...
								<td>
									...
									<div class="btn-group btn-group-sm" role="group"
										aria-label="...">
										<a href="fees?id=${s.studentId }"
											class="btn btn-outline-success">PayFees</a> <a
											href="changeBatch?id=${s.studentId }"
											class="btn btn-outline-primary">ShiftBatch</a> <a
